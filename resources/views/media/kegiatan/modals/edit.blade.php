    ...
    <div
        ...
        <div class="px-6 py-5 border-b border-slate-100 flex justify-between items-start">
            <div class="flex gap-4">
                <div
                    class="w-10 h-10 bg-amber-50 rounded-xl flex items-center justify-center text-amber-700 shrink-0 border border-amber-100/50">
                    <i class="fa-solid fa-pen-to-square text-base"></i>
                </div>
                <div>
                    <h3 class="font-bold text-sm text-slate-800 tracking-tight">Koreksi portofolio</h3>
                    <p class="text-slate-400 text-[11px] mt-0.5 font-medium">Perbaikan tulisan atau perbarui lampiran
                        foto.</p>
                </div>
            </div>
        ...
        <form id="formEditKegiatan" method="POST" enctype="multipart/form-data" class="text-xs">
            ...
            <div class="px-6 py-4 space-y-4 max-h-[65vh] overflow-y-auto">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 pb-3 border-b border-slate-50">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="sub_judul" id="edit_sub_judul" required
                ...
                <div class="pb-3 border-b border-slate-50">
                    ...
                    <textarea name="deskripsi" id="edit_deskripsi" rows="3" required maxlength="500"
                    ...
                    <div class="flex justify-end mt-1">
                        <span class="text-xs text-slate-400">
                            <span id="edit_hitung_karakter" class="font-medium text-slate-500">0</span> / 500 karakter
                        </span>
                    </div>
                </div>
                ...
                <div class="pb-3 border-b border-slate-50">
                    <label class="block font-semibold text-slate-700 mb-1.5">Foto <span
                            class="text-slate-400 font-normal">(Kosongkan jika tidak ingin mengganti
                            foto)</span></label>

                    <img id="edit_foto_preview" src="" alt="Foto saat ini"
                        class="hidden w-28 h-18 object-cover rounded-lg border border-slate-200 mb-2">
            ...
            <div class="px-6 py-4 bg-slate-50/60 border-t border-slate-100 flex justify-end gap-2">
                ...
                <button type="submit"
                    class="px-4 py-2.5 bg-slate-800 hover:bg-slate-900 text-white rounded-xl font-bold shadow-sm cursor-pointer">Simpan
                    Perubahan</button>
            </div>
        </form>
    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        // Sesuaikan target ID baru khusus edit
        const textarea = document.getElementById('edit_deskripsi');
        const counter = document.getElementById('edit_hitung_karakter');
