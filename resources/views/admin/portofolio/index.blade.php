...
<div id="modalTambah" class="fixed inset-0 z-50 hidden items-center justify-center p-4">
    ...
    <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg z-10 overflow-hidden max-h-[90vh] flex flex-col">
        ...
        <form action="{{ route('admin.portofolio.store') }}" method="POST" enctype="multipart/form-data"
            ...
            @csrf
            <div>
                <label class="block font-semibold text-slate-700 mb-1.5">Judul Proyek <span class="text-rose-500">*</span></label>
            ...
            <div>
                <label class="block font-semibold text-slate-700 mb-1.5">Sub Judul <span class="text-rose-500">*</span></label>
                <input type="text" name="sub_judul" required placeholder="Contoh: E-Commerce / Web Development"
                    class="w-full px-3 py-2.5 rounded-xl border border-slate-200 focus:outline-none focus:border-blue-600 focus:ring-4 focus:ring-blue-600/5 transition-all">
            </div>
            <div>
                <label class="block font-semibold text-slate-700 mb-1.5">Deskripsi <span class="text-rose-500">*</span></label>
            ...
            <div>
                <label class="block font-semibold text-slate-700 mb-1.5">Foto Proyek <span class="text-rose-500">*</span></label>
    ...
    <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-sm z-10">
        <div class="p-6 text-center space-y-4 text-xs">
            ...
            <div>
                ...
                <p class="text-slate-500 mt-1">Proyek <span id="hapus_nama" class="font-bold text-slate-800"></span> dan fotonya akan dihapus permanen.</p>
            </div>
