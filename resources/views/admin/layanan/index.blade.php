        ...
        <table class="w-full text-left">
            <thead class="bg-slate-50 border-b border-slate-200">
                <tr>
                    ...
                    <th class="px-5 py-3.5 font-bold text-slate-600 uppercase tracking-wider text-[10px]">Nama Layanan</th>
                    <th class="px-5 py-3.5 font-bold text-slate-600 uppercase tracking-wider text-[10px]">Deskripsi</th>
                    <th class="px-5 py-3.5 font-bold text-slate-600 uppercase tracking-wider text-[10px] text-right">Aksi</th>
                </tr>
            </thead>
                ...
                <tr class="hover:bg-slate-50 transition-colors">
                    ...
                    <td class="px-5 py-4 text-right">
                        <div class="flex items-center justify-end gap-2">
                            <button onclick="bukaModalEdit({{ $item->id }}, '{{ addslashes($item->nama_layanan) }}', '{{ addslashes($item->deskripsi_singkat) }}', '{{ $item->icon }}')"
...
<div id="modalTambah" class="fixed inset-0 z-50 hidden items-center justify-center p-4">
    ...
    <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-md z-10 overflow-hidden">
        ...
        <form action="{{ route('admin.layanan.store') }}" method="POST" class="p-6 space-y-4 text-xs">
            @csrf
            <div>
                <label class="block font-semibold text-slate-700 mb-1.5">Nama Layanan <span class="text-rose-500">*</span></label>
            ...
            <div>
                <label class="block font-semibold text-slate-700 mb-1.5">Deskripsi Singkat <span class="text-rose-500">*</span></label>
                <textarea name="deskripsi_singkat" rows="3" required placeholder="Jelaskan layanan ini secara singkat..."
    ...
    <span class="text-slate-400 font-normal">(opsional, contoh: fa-solid fa-code)</span>
                ...
                <p class="text-[10px] text-slate-400 mt-1">Lihat daftar icon di <a href="https://fontawesome.com/icons" target="_blank" class="text-blue-600 hover:underline">fontawesome.com/icons</a></p>
            </div>
    ...
    <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-sm z-10">
        <div class="p-6 text-center space-y-4 text-xs">
            ...
            <div>
                ...
                <p class="text-slate-500 mt-1">Layanan <span id="hapus_nama" class="font-bold text-slate-800"></span> akan dihapus permanen.</p>
            </div>
